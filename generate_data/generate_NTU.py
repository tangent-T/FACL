...
# key_save_path = '../ntu/resolution10_app/others/'  # '/3DV_pointdata/NTU_voxelsize35_split5'
# save_path = '../ntu/resolution10_app/raw/'
# app_save_path = '../ntu/resolution10_app/app/'
...
def main():
    ...
    resolution = ['Resolution60', 'Resolution30', 'Resolution10']
    # logging.basicConfig(format='%(asctime)s %(message)s', datefmt='%Y/%m/%d %H:%M:%S',filename='/data/data3/tanbo/ntu/3DV_ntu60/3DV_generate.log', level=logging.INFO)
    # logging.info('======================================================')
    for su_resolution in resolution:
        key_save_path = '../ntu/resolution/'+ su_resolution+ '/others/'  # '/3DV_pointdata/NTU_voxelsize35_split5'
        save_path = '../ntu/resolution/'+ su_resolution+ '/raw/'
        app_save_path = '../ntu/resolution/'+ su_resolution+ '/app/'
        if not os.path.exists(key_save_path):
            os.makedirs(key_save_path)
            os.makedirs(save_path)
            os.makedirs(app_save_path)
