...
def main(args=None):
    ...
    data_train = NTU_RGBD_new(root_path='../ntu/3DV_ntu60/reslution/Resolution60/raw/', opt=opt,
                          # opt.root_path
    ...
    for epoch in range(0, opt.nepoch):
        ...
        if epoch % 5 == 0:
            torch.save(netR.module.state_dict(), '%s/corr_GL_%d.pth' % (opt.save_root_dir, epoch)) # no_ss_implify_
