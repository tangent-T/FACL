...
def main(args=None):
    ...
    parser.add_argument('--branch_choose', type=str,
                        default='1', help='choose which branch motion or apperance')
    ...
    model_name = '../ntu/ntu60_new2/model/corr_GL_appereance_60.pth' 
    ...
    netR.eval()
    save_path = '/data/data1/ntu/feature/ntu60/cv/G_L/app_corr/'
